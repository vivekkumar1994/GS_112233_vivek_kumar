...
const GrossMargin: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const storeData = weeks.map((week, index) => {
            ...
            const grossMargin = salesPrice ? (profit / salesPrice) * 100 : 0;
    ...
    useEffect(() => {
        ...
        const options: AgChartOptions = {
            ...
            title: { text: 'Financial Performance by Week', fontSize: 18 },
    ...
    return (
        <Paper elevation={3} sx={{ p: 4 }}>
            <Typography variant="h5" gutterBottom>
                Sales, Cost, Profit, Loss, and Gross Margin Chart
            </Typography>
